...
../../src/opera/datacenter/htsim_ndp_dynexpTopology -utiltime 5e-04 -simtime 0.801 -cutoff 15000000 -cwnd 20 -q 65 -pullrate 1 -topfile ../../topologies/dynexp_50us_10nsrc_1path.txt -flowfile ../traffic_gen/datamining_uniform_40percLoad_0.5sec_648hosts.htsim > Opera_1path_datamining_ndp_0.5sec_0.8sec_50us.txt

../../src/opera/datacenter/htsim_ndp_dynexpTopology -utiltime 5e-04 -simtime 0.801 -cutoff 0 -cwnd 20 -q 65 -pullrate 1 -topfile ../../topologies/dynexp_50us_10nsrc_1path.txt -flowfile ../traffic_gen/datamining_uniform_40percLoad_0.5sec_648hosts.htsim > VLB_datamining_rotorlb_opera_0.5sec_0.8sec_50us.txt
