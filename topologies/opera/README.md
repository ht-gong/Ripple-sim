...
For fair comparison, we need to change Opera's reconfiguration time. Simply change the second line with "324 49880000 620000 10000" and we will have dynexp_50us_10nsrc_1path.txt

Note that due to the randomness when generating Opera's topology, the file can be different.

We cannot use Opera's codebase to generate the 5-path version, and only can obtain the raw 5-path file from Opera's github webpage.
