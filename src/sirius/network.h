...
class Packet {
 ...
 public:
    ...
    void set_nextToR(int nextToR) {_nextToR = nextToR;}
    int get_nextToR() {return _nextToR;}
 ...
 protected:
    ...
    int _crtToR; // current ToR (ToR from which the routing is calculated) //SIRIUS EDIT
    int _nextToR; // next ToR (ToR calculated from routing, pipe will lead there regardless) //SIRIUS EDIT
